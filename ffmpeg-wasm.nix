...
stdenv.mkDerivation (finalAttrs: {
  ...
  configurePhase = ''
      ./configure \
          ...
          --extra-ldflags="-pthread -target wasm32-wasip1-threads -Wl,--max-memory=2147483648 -Wl,--import-memory -Wl,--export-memory -lwasi-emulated-process-clocks -lwasi-emulated-signal -msimd128" # \
          #--enable-zlib \
 '';
